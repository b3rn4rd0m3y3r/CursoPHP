		...
		<?php
			...
			case "addsave":
				...
				*/
				...
				?>
				<a href="Email.asp?Para=<?php echo $_POST["Email"] ?>&TituloEmail=<?php echo $SUBTITULO ?>&Nome=<?php echo $_POST["Nome"] ?>&Ramal=<?php echo $_POST["Contato"] ?>">Receber Email</a>
				<?php
				echo $BACK_MAIN_SCREEN;
				break;
			...
			case "dele":
				...
				<a href="?action=delesave&Id=<?php echo $Id ?>&DTD=<?php echo $CONFIG; ?>&CodUsr=<?php echo $User; ?>">CONFIRMA DELE&Ccedil;&Atilde;O DO REGISTRO <?php echo $Id ?></a>
				</center>
				<?php
				break;
		...
		?>
			<center>
				...
				<form method="post" action="?action=list&DTD=<?php echo $CONFIG; ?>&CodUsr=<?php echo $User; ?>">
					...
					<p style="margin-left: 25%;color: crimson;" align=justify>Preencha um dos campos acima e pressione o bot&atilde;o que est&aacute; na mesma linha do campo para pesquisar.<br>
					Por exemplo, para pesquisar por nome, preencha o campo de nome e pressione o bot&atilde;o de Nome, logo &agrave; frente.</p>
					</div>
				</form>
				<p>
					<button class="openform" onclick="window.location.href = '?action=add&DTD=<?php echo $CONFIG; ?>&CodUsr=<?php echo $User; ?>';">
					<span class=contorno>ABRIR O FORMUL&Aacute;RIO DE INCLUS&Atilde;O DE REGISTRO</span></button>
				</p>
			</center>
		<?php
			}
