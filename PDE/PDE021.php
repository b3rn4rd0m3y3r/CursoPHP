	...
	<body>
		...
		<?php
			...
			case "editsave":
				...
				echo $BACK_MAIN_SCREEN;
				break;
			// AÃ§Ã£o de preparaÃ§Ã£o de  deleÃ§Ã£o de registros
			case "dele":
				if( $IDFOUND == 0 ){ // Teste de presenÃ§a de um parÃ¢metro Id
					exit("<span class=erro>PDE - DeleÃ§Ã£o necessita do parÃ¢metro Id preenchido.</span>");
					}
				$Id = $_GET["Id"];
				...
				<a href="?action=delesave&Id=<?php echo $Id ?>&CodUser=1">CONFIRMA DELEÃ‡ÃƒO DO REGISTRO <?php echo $Id ?></a>
				</center>
				<?php
				break;
			// AÃ§Ã£o de persistÃªncia de  deleÃ§Ã£o de registros
			case "delesave":
				echo "Efetiva a deleÃ§Ã£o.";
