	...
	<body>
			...
			<table>
				<tr>
					...
					<td>
						...
						<iframe width=700 height=500 src="http://intranet-se01/dvpi/ctstockaeco/PDE022a_pesq.php?DTD=./Prod_pesq.json&CodUsr=1">
						</iframe>
		...
		?>
			<center>
				...
				<p>
					<button class="openform" onclick="window.location.href = '?action=add&DTD=<?php echo $CONFIG; ?>&CodUsr=<?php echo $User; ?>';"><span class=contorno>ABRIR O FORMULÁRIO DE INCLUSÃO DE REGISTRO</span></button>
				</p>
			</center>
		<?php
			}
